...
def show_analysis_page():
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/image/analysis_page.png?raw=true"
    )

    st.write("""### Average Salary by Gender""")
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/average_salary_by_gender.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/city_distribution.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/mean_salary_by_work_type.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/highest_average_salary_with_technologies.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/outlier_detection_scatter_plot.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/top_10_cities_salary.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/top_10_positions_frequency.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/top_10_positions_salary.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/top_10_field_average_salary.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/frequency_of_levels.png?raw=true"
    )
    st.write(
    ...
    st.image(
        "https://github.com/alicenkbaytop/salary-prediction-2024/blob/main/chart/correlation_matrix_heatmap.png?raw=true"
    )
    st.write(
